...
//	if(RC_Control.ARMED==0)SumX=SumY=0;
//	OFF_CS();
//	delay_us(4);
//	OFF_CS();
//	high=Alt_ultrasonic;
// Mag.x=sum_x=(25.4*(float)SumX *high)/(12*1600);//距离=d_x*(25.4/1600)*n   其中n=像高:物高=8毫米:物长
// Mag.y=sum_y=(25.4*(float)SumY *high)/(12*1600);
//// Mag.x=sum_x=(25.4*(float)SumX *H)/(12*1600);//距离=d_x*(25.4/1600)*n   其中n=像高:物高=8毫米:物长
//// Mag.y=sum_y=(25.4*(float)SumY *H)/(12*1600);
//  if(move&0x10!=1)
//	if(move&0x80)
//	{
