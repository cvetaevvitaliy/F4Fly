...
#define PWM_SetCompare1(x)  TIM_SetCompare1(TIM8, (x));
#define PWM_SetCompare2(x)  TIM_SetCompare2(TIM8, (x));
#define PWM_SetCompare3(x)  TIM_SetCompare1(TIM2, (x));
#define PWM_SetCompare4(x)  TIM_SetCompare2(TIM2, (x));
